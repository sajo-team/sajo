    ...
    @Query(value = """
            ...
            indicator_status as (
                select
                    ...
                    max(financial_reference_year_month) as latest_financial_reference_year_month
                from m_market_stocks_indicator
                where reference_date is not null
                   or financial_reference_year_month is not null
            )
            select
                ...
                indicator_status.latest_financial_reference_year_month
            from price_status
