...
public enum StrategyErrorCode implements ErrorCode {
    ...
    BACKTEST_NOT_FOUND(HttpStatus.NOT_FOUND, "STRATEGY_0003", "백테스트를 찾을 수 없습니다."),
    STRATEGY_ACCESS_DENIED(HttpStatus.FORBIDDEN, "STRATEGY_0004", "해당 전략에 접근할 권한이 없습니다."),
    BACKTEST_ACCESS_DENIED(HttpStatus.FORBIDDEN, "STRATEGY_0005", "해당 백테스트에 접근할 권한이 없습니다.");
