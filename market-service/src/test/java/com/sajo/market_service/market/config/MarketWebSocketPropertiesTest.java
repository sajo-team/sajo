...
class MarketWebSocketPropertiesTest {
    ...
    void appliesDefaultsWhenNothingIsConfigured() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, null, "", null, null, 0, null, null, 0);
    ...
    void keepsExplicitMaxBackoffWhenNotSmallerThanInitialBackoff() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(2), Duration.ofSeconds(20), 3.0, List.of(), null, 0);
    ...
    void unconfiguredMaxBackoffFallsBackToDefaultWhenInitialBackoffIsSmaller() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(5), null, 2.0, List.of(), null, 0);
    ...
    void maxBackoffNeverEndsUpSmallerThanInitialBackoffEvenWhenExplicitlyConfiguredTooSmall() {
        ...
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(40), null, 2.0, List.of(), null, 0);
    ...
    void explicitMaxBackoffSmallerThanInitialBackoffIsClampedUpToInitialBackoff() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(10), Duration.ofSeconds(3), 2.0, List.of(), null, 0);
    ...
    void explicitBackoffMultiplierNotGreaterThanOneFallsBackToDefault() {
        ...
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 1.0, List.of(), null, 0);
    ...
    void normalizesCommaSeparatedAndDeduplicatesTargetStockCodes() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                ...
                List.of("005930,000660", " 005930 "), null, 0);
    ...
    void allowsBlankSystemUserIdWhenDisabled() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 2.0, List.of(), null, 0);
    ...
    void rejectsBlankSystemUserIdWhenEnabled() {
        assertThatThrownBy(() -> new MarketWebSocketProperties(
                true, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 2.0, List.of(), null, 0))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void appliesDefaultTextMessageBufferSizeWhenUnconfiguredOrInvalid() {
        MarketWebSocketProperties unconfigured = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 2.0, List.of(), null, 0);
        assertThat(unconfigured.textMessageBufferSize()).isEqualTo(131_072);

        MarketWebSocketProperties negative = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 2.0, List.of(), null,
                -1);
        assertThat(negative.textMessageBufferSize()).isEqualTo(131_072);
    }

    @Test
    void keepsExplicitTextMessageBufferSize() {
        MarketWebSocketProperties properties = new MarketWebSocketProperties(
                false, "ws://kis.example", "", Duration.ofSeconds(1), Duration.ofSeconds(30), 2.0, List.of(), null,
                65_536);

        assertThat(properties.textMessageBufferSize()).isEqualTo(65_536);
    }
}
